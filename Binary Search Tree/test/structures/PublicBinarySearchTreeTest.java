...
public class PublicBinarySearchTreeTest {
	...
	public void testEquals() {
		...
		tree.add(new String("hoo"));
		tree.add(new String("woo"));
		tree.add(new String("goo"));
		
		oneNodeTree.add(new String("goo"));
		oneNodeTree.add(new String("hoo"));
		oneNodeTree.add(new String("woo"));
		assertFalse(oneNodeTree.equals(tree));
	}
