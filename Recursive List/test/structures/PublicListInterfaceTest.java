...
public class PublicListInterfaceTest {
	...
	public void testInsert() {
		...
		list.insertAt(2, "whats up");
		assertEquals(list.get(2), "whats up");
		list.insertAt(list.size(), "yoyo");
		assertEquals(list.getLast(), "yoyo");
		list.insertAt(0, "bye");
		assertEquals(list.getFirst(), "bye");
		list.insertLast("wassup");
		assertEquals(list.getLast(), "wassup");
		assertEquals(list.indexOf("wassup"), list.size()-1);
		assertEquals(list.indexOf("badup"), -1);
	}
	@Test
